...
{
#if _XBOX_ONE
	uint Index0 = asuint( __XB_GetRawInterpoland(vertexID, 0) );
	uint Index1 = asuint( __XB_GetRawInterpoland(vertexID, 1) );
	uint Index2 = asuint( __XB_GetRawInterpoland(vertexID, 2) );
#else
	// TBD SM6.1 stuff
